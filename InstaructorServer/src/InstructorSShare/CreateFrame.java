...
class CreateFrame extends Thread {
	...
	private JInternalFrame interFrame = new JInternalFrame("title", true, true, true);
	private JPanel cPanel = new JPanel();

	public CreateFrame(Socket cSocket, String width, String height, String pcName) {
		interFrame.setTitle(pcName);
		this.width = width;
		this.height = height;
	...
	public void drawGUI() {
		...
		frame.setExtendedState(frame.getExtendedState() | JFrame.MAXIMIZED_BOTH); // CHECK
																					// THIS
																					// LINE
